...
#include "usart.h"
#include "stdio.h"
int Motor1_Encoder_Value=0;
int Motor2_Encoder_Value=0;
...
void GROUP1_IRQHandler(void){
	if(DL_Interrupt_getStatusGroup(DL_INTERRUPT_GROUP_1,DL_INTERRUPT_GROUP1_GPIOB)){
		unsigned int Encoder_GPIO_Int = DL_GPIO_getEnabledInterruptStatus(Encoder_PORT,Encoder_A_PIN | Encoder_B_PIN | Encoder_C_PIN | Encoder_D_PIN);
		//通道1 左轮A相
