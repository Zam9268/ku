...
#define  OLED_W_SCL(x)  ((x)?(DL_GPIO_setPins(IIC_SCL_PORT,IIC_SCL_PIN)) : (DL_GPIO_clearPins(IIC_SCL_PORT,IIC_SCL_PIN)) )
#define  OLED_W_SDA(x)  ((x)?(DL_GPIO_setPins(IIC_SDA_PORT,IIC_SDA_PIN)) : (DL_GPIO_clearPins(IIC_SDA_PORT,IIC_SDA_PIN)) )
#endif
